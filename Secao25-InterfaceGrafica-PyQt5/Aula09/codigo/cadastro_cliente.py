...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btnNovo.clicked.connect(self.novoCliente)
        self.btnAlterar.clicked.connect(self.alterarCliente)
        self.btnSalvar.clicked.connect(self.salvarCliente)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Cadastro de Clientes"))
    ...
    def listarClientes(self):
        #self.bancodados.conectar()
        self.model = self.bancodados.listarClientes()
    ...
    def inserirCliente(self):
        ...
        cliente['telefone'] = self.edtTelefone.text()
        cliente['celular'] = self.edtCelular.text()
        cliente['endereco'] = self.edtEndereco.text()

        #self.bancodados.conectar()
        self.bancodados.inserirCliente(cliente)
        #self.bancodados.desconectar()

    # Código adicionado
    def atualizarCliente(self):
        cliente = {}
        cliente['idclientes'] = self.idclientes
        cliente['nome'] = self.edtNome.text()
        cliente['telefone'] = self.edtTelefone.text()
        cliente['celular'] = self.edtCelular.text()
        cliente['endereco'] = self.edtEndereco.text()
        ...
        #self.bancodados.conectar()
        self.bancodados.alterarCliente(cliente)
        #self.bancodados.desconectar()
    ...
    def selecionarLinha(self):
        ...
        #self.idclientes = self.model.record(rows[0].row()).value("idclientes")
        self.idclientes = self.model.record(linha).value("idclientes")
