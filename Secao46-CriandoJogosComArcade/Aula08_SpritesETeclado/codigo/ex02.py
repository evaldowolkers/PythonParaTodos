...
class Game(arcade.Window):
    ...
    def on_update(self, delta_time: float):
        ...
        # Manter o player na Janela
        # Se a posição superior do player (top)
        # for maior que a altura da tela, ele
        # recebe a altura da tela
        # o mesmo vale para direita, esquerda e
        # parte inferior para que não saia da tela
